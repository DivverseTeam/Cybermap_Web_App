...
export default function SignInForm({ headerTitle, headerSubtitle }: Props) {
        ...
        <div className="flex flex-col gap-[1rem] w-full max-h-[679px]">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className=" w-full">
            <div className="gap-4 space-y-4">
              ...
              />
              <p className="select-none flex justify-between ml-auto w-fit text-[#305EFF] hover:underline font-semibold cursor-pointer">
                Forgot Password
              </p>
