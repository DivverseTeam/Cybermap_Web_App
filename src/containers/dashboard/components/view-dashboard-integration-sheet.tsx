...
interface ViewDashboardIntegrationSheetProps
  extends React.ComponentPropsWithRef<typeof Sheet> {
  integration: Row<IntegrationType>["original"];
}
...
export function ViewDashboardIntegrationSheet({
  integration,
  open,
  onOpenChange,
  ...props
}: ViewDashboardIntegrationSheetProps) {
  return (
