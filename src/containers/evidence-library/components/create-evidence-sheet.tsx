          ...
          >
              ...
              render={({ field }: any) => (
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectGroup>
                        {evidences.status.enumValues.map((item: any) => (
                          <SelectItem
                            key={item}
                            value={item}
            ...
            <div className="flex flex-col">
              ...
              <Input
                ...
                className={cn(
                  "block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500",
                  "file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-500 file:text-white hover:file:bg-blue-600"
                )}
              />
              {file && (
