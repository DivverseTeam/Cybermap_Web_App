      ...
      {employee ? (
        <SheetContent className="flex h-full flex-col gap-3 overflow-y-auto">
          ...
          <div className="p-4 py-6 flex flex-col gap-6">
            ...
            {/* summary table */}
            <div className="overflow-auto text-secondary">
            ...
            {!statusEditActive ? (
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-col text-secondary text-sm">
                    ...
                    <p>
                      Edit the employee’s compliance status only when necessary,
                      as manual changes can affect records and reports
                    </p>
                  </div>
              ...
              <div className="space-y-4 border h-max rounded-lg p-4">
                <h2 className="font-medium text-lg">Edit compliance status</h2>
                <div className="">
                  {complianceList.map((compliance, index) => {
                    const entry = Object.entries(compliance)[0]; // Extract the first entry (key-value pair)

                    console.log(statusEditActive);
                ...
                <div className="flex justify-start gap-2">
                  <Button onClick={() => setStatusEditActive(false)}>
                    Save changes
                  </Button>
                  <Button
                    variant={"destructive"}
          ...
          <SheetFooter className="flex px-4 mt-16 flex-col-reverse sm:flex-row sm:justify-start sm:space-x-2">
            <Button variant={"default"}>Create Ping</Button>
